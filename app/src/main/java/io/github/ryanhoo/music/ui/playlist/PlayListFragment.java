...
public class PlayListFragment extends BaseFragment implements PlayListContract.View,
    ...
    }//加载fragment_play_list，用默认容器，不用bundle保存数据
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {//每个歌曲项目的点击事件
            @Override
            public void onItemClick(int position) {
                PlayList playList = mAdapter.getItem(position); //读音乐文件肯定在这里面
                //这里不用Intent，直接在Main里面开了一个新的Activity?
