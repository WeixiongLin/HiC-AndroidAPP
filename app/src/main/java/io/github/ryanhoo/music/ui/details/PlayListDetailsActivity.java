...
public class PlayListDetailsActivity extends BaseActivity implements PlayListDetailsContract.View, SongAdapter.ActionCallback {
    ...
    public static  String current_songpath="";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                current_songpath=mPlayList.getSongs().get(1).getPath();
                Log.e("修改2,林玮雄机子需要","歌曲路径没有："+current_songpath);
            }
        });
